...
public class EmployeeDataAnalyzer {
	...
	public static void main(String[] args) {
        ...
        employeeManager.addEmployee(new Employee(1, "Mike", "Engineering", 75000.0));
        employeeManager.addEmployee(new Employee(2, "Lucas", "Marketing", 68000.0));
        employeeManager.addEmployee(new Employee(3, "Dustin", "Engineering", 80000.0));
        employeeManager.addEmployee(new Employee(4, "Will", "HR", 55000.0));
